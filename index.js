...
const connectKeWA = () => {
const semar = makeWASocket({logger:pino({level:'silent'}),printQRInTerminal: true,auth: state,browser: ["RndyBotz", "Dekstop", "3.0"]})
...
msg = denz.messages[0]
nomorOwner = ['62895419965976','62895419965976']
nomorDeveloper = ['62895419965976']
